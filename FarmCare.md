...
| :--- | :--- | :--- | :--- |
| `id` | INT | Primary Key | Unique identifier |
| `name` | VARCHAR(100) | Unique, Not Null | Name of district |
...
| `image` | VARCHAR(100) | Not Null | Path to image file |
| `caption` | TEXT | Nullable | Image caption |
| `category` | VARCHAR(50) | Default 'farm' | Photo category |
| `uploaded_by_id` | INT | Foreign Key, Nullable | User who uploaded the image |
| `created_at` | DATETIME | Not Null | Upload timestamp |
| `is_featured` | BOOLEAN | Default False | Feautured image flag |
...
| `posted_by_id` | INT | Foreign Key, Nullable | Admin who posted it |
...
| :--- | :--- | :--- | :--- |
| `id` | INT | Primary Key | Unique identifier |
| `name` | VARCHAR(200) | Not Null | Team member name |
| `role` | VARCHAR(200) | Not Null | Member role/title |
| `bio` | TEXT | Nullable | Short biography |
| `image` | VARCHAR(100) | Nullable | Path to profile image |
